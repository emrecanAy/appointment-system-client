...
const App = () => {
    ...
    try {
      ...
      if (response.data) {
        ...
        response.data.role === "ADMIN"
          ...
          : navigate(`/dashboard/staff-stats/${response.data.staffId}`, { state: { user: response.data } });
      }
    } catch (error) {
  ...
  const onFinish = (values) => {
    role === Role.STAFF ? handleStaffLogin(values.email, values.password) : handleCustomerLogin(values.email, values.password);
